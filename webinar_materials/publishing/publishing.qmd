...
:::{style="position: absolute; width: 45%; top: 33%; right: 40px; text-align: right;"}
[Getting the Car on the Track: publishing to Connect]{style="color: #ffffff; font-size: 4rem;"}
:::
...
- Think of our products, Workbench, Connect, and Package Manager, as garages or workshops where your tools can be organized and managed so that you can build and share
...
- R, Python, Julia, JavaScript, and more
- Programming languages consist of code
- Code is organized into packages, aka, digital bundles of code, documentation, and data
- Programming languages come with some packages included
- People develop more packages to add new capabilities to the core programming language
...
- Development = building things = Posit Workbench
- Production =  sharing things and rebuilding things = Posit Connect
- Package management = giving everyone the right tools = Posit Package Manager
...
:::{style="position: absolute; width: 40%; top: -62px; right: 8px; text-align: left;"}
